...
$final_graphData_payment_methodstock = json_encode($chart_dataStock);
...
<div class="chart-responsive" style="margin-top: 20px;text-align: center;">
    <!-- Sales Chart Canvas -->
    <canvas id="pieChartSalespaymenthodstock" height="200px"></canvas>
...
<script>
    ...
    $(function() {
        ...
        let pieChartCanvas = $("#pieChartSalespaymenthodstock").get(0).getContext("2d");
        let pieChart = new Chart(pieChartCanvas);


        let graphData_payment_method = <?php echo $final_graphData_payment_methodstock ?>;

        let PieData_sale_payment_method = [];
