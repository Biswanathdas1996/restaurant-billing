        ...
        if(mysqli_num_rows($retval) > 0){  
         while($row = mysqli_fetch_assoc($retval)){  
              ...
              $nestedData=[];
                ...
                $nestedData[]=base64_encode($row['id']);          
              ...
              $nestedData[]="<form action='../ajax_api/send_invoice.php' class='form-inline'>
                ...
                <a href='../../../invoice/download.php?id=".$row['id']."' target='_blank'> <button type='Button' class='btn btn-success'><i class='fa fa-download'></i></button></a>
