            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Monthly Scan Report</h3>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="chart-responsive">
                        <!-- Sales Chart Canvas -->
                        <canvas id="salesChart" height="290"></canvas>
...
$(function () {
  ...
  var level_array =<?php echo json_encode($levelSet );?>;
  var dataGraph =<?php echo json_encode($dataGraph );?>;
  console.log("level_array",level_array)
    ...
    //   },
      {
        ...
        strokeColor: "#11998e",
        pointColor: "#3b8bba",
        pointStrokeColor: "#11998e",
        pointHighlightFill: "#fff",
        pointHighlightStroke: "#11998e",
        // data: ["<?php echo $w;?>", 48, 40, 19, 86, 27, 90]
        data: dataGraph
      }
    ]
  };
