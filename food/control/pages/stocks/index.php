  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number" id="total_amounts">..</span>
  ...
  <div class="col-md-12">
    ...
    <div class="box box-info">
      <div class="box-header with-border">
        <div class="row">
          <div class="col-md-2">
            <h3 class="box-title">Total stock add</h3>
          </div>
          ...
          <div class="col-md-6">
            ...
            <button type="button" class="btn btn-info btn-lg" style="float: right;border-radius: 0px; " id="todays_stock">
              <span class="glyphicon glyphicon-equalizer"></span> Today's Added stock </button>
          ...
          <div class="col-md-2">
            <a href="../add_stock">
              <button type="button" class="btn btn-primary btn-lg" style="float: right;border-radius: 0px;"><span class="glyphicon glyphicon-plus"></span> Add New Stock</button>
            </a>
          </div>
        </div>
      </div><!-- /.box-header -->
...
<script>
  $(document).ready(function() {
    ...
    function getTotal(startDate = null, endDate = null) {
      let url = null;
      if (startDate != null && endDate != null) {
        url = "wiget.php?startDate=" + startDate + "&endDate=" + endDate;
      } else {
        url = "wiget.php";
      }
      $.ajax({
